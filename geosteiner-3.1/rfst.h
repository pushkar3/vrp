/***********************************************************************
	...
	Copyright (c) 1998, 2001 by Martin Zachariasen and David M. Warme
...
/*
 * The various types of backbone styles.
 */

#if 0

enum backbone {
	ZERO_H_REST_V,		/* Zero on Horizontal leg, rest on Vertical */
	ONE_H_REST_V,		/* One on Horizontal leg, rest on Vertical */
	ZERO_V_REST_H,		/* Zero on Vertical let, rest on Horizontal */
	ONE_V_REST_H,		/* One on Vertical leg, rest on Horizontal */
	ZERO_H_ZERO_V,		/* Simple two-point backbone */
	ONLY_H,			/* Backbone is exactly horizontal */
	ONLY_V,			/* Backbone is exactly vertical */
	CROSS,			/* The ultimate degeneracy -- a cross */
	FAKE			/* Internal use only -- no geometric meaning */
};
...
extern dist_t		bmst_length (struct pset *, struct bsd *);
extern dist_t		bmst_terms_length (int *, int, struct bsd *);
